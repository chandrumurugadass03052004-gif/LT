document.addEventListener('DOMContentLoaded', () => {
  ...
  const translations = {
    ...
    'ta': {
      ...
      'about_founder_desc': '2012 ஆம் ஆண்டில் <strong>முருகதாஸ் பி</strong> என்பவரால் தொடங்கப்பட்ட லீஷா டிரேடர்ஸ், போடிநாயக்கனூர் ஏலக்காய் பெல்ட்டின் வளமான மண்ணில் வேரூன்றியுள்ளது. <strong>12-க்கும் மேற்பட்ட மதிப்புமிக்க ஏல அனுமதிகள்</strong> மற்றும் எங்களின் சொந்த <strong>ஏலக்காய் தோட்டங்களின்</strong> ஆதரவுடன், மிகச்சிறந்த, தரமான ஏலக்காயை நேரடியாக விளைநிலத்திலிருந்தே உங்களுக்கு வழங்குகிறோம்.',
